...
int main(int argc, const char *argv[]) {
	if(argc<6) {cerr << "Requires 6 parameters:\n"
    ...
    if(MF3==2 && MF4==2) {
        ...
        for(int d01=0; d01<N; ++d01) for(int d02=0; d02<N; ++d02) { //loop over all sites
            if(d01<5 && d02<5) y[d01][d02][0][1][0] = 1.0;
    ...
    for (double t_target = t+t_step; t_target < 10.0; t_target += t_step ) { //stop by time
        ...
        */
        ...
        for(int d01=0; d01<N; ++d01) for(int d02=0; d02<N; ++d02) {
            for(int d3=0;d3<MF3-2;++d3) {
                double sum = 0.0;
                    for(int d4=0;d4<MF4-1;++d4) sum += y[d01][d02][0][d3][d4];
